...
# on les place dans la boite à outils
boite_outil.add_tool(tournevis)
boite_outil.add_tool(marteau)

# on affiche le contenu de la boite à outils
print (boite_outil.tools)

# on instancie une vis et on la serre avec le tournevis
vis=Screw()
...
# on instancie un clou et on le plante avec le marteau
